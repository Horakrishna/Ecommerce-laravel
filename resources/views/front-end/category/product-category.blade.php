                ...
                <div class="product-agileinfo-grids w3l">
                    <div class="col-md-3 product-agileinfo-grid">
                        ...
                        <div class="top-rates">
                            ...
                            <div class="recent-grids">
                                <div class="recent-left">
                                    <a href="single.html"><img class="img-responsive " src="{{ asset('/') }}front-end/{{ asset('/') }}front-end/images/r3.jpg" alt=""></a>
                                </div>
                                <div class="recent-right">
                                                ...
                                                <div  class="grid-arrival">
                                                    <figure>
                                                        <a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                                            ...
                                                            <div class="grid-img">
                                                                <img  src="{{ asset($categoryProduct->product_image) }}front-end/images/s1.jpg" class="img-responsive"  alt="">
                                                            </div>
                                                        </a>
                                                    </figure>
                                                </div>
